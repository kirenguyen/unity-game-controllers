...
class iSpyGameStates(): # pylint: disable=too-few-public-methods
    ...
    class Triggers():
        ...
        triggers = [N_SECONDS_LATER, PRACTICE_FAILED,PRACTICE_FINISHED ,PRONUNCIATION_PANEL_CLOSED,
                    NONTARGET_OBJECT_COLLECTED, TARGET_OBJECT_COLLECTED, SAY_BUTTON_PRESSED,
                    SCREEN_MOVED, START_BUTTON_PRESSED, CONNECT_BUTTON_PRESSED, HINT_BUTTON_PRESSED, 
                    TOPLEFT_BUTTON_PRESSED,OBJECT_CLICKED, APPLICATION_QUIT]
